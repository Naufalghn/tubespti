<?php
	...
	class Nilai extends CI_Controller
	{
		...
		function index()
		{
			$sql = "SELECT tj.kd_kelas, tj.id_jadwal, tju.nama_jurusan, ttk.nama_tingkatan, tm.nama_mapel, tj.jam, tj.hari
					FROM tbl_jadwal AS tj, tbl_jurusan AS tju, tbl_mapel AS tm, tbl_tingkatan_kelas AS ttk
					WHERE tj.kd_jurusan = tju.kd_jurusan AND tj.kd_mapel = tm.kd_mapel AND tj.kd_tingkatan = ttk.kd_tingkatan AND tj.id_guru =".$this->session->userdata('id_guru');

	...
	class Jadwal extends CI_Controller
	{
		...
		function dataJadwal()
		{
			...
			echo "<table class='table table-striped table-bordered table-hover table-full-width dataTable'>
  			...
  			$sql_datajadwal	= "SELECT tj.id_jadwal, tm.kd_mapel, tg.id_guru, tg.nama_guru, tr.kd_ruangan, tj.hari, tj.jam
			...
			foreach ($data_jadwal as $row) {
				echo "<tr>
						...
						<td>".cmb_dinamis('mapel', 'tbl_mapel', 'nama_mapel', 'kd_mapel', $row->kd_mapel, "id='mapel".$row->id_jadwal."' onChange='updateMapel(".$row->id_jadwal.")'")."</td> 
		...
		function update_mapel()
		{
			...
			$this->db->update('tbl_jadwal', array('kd_mapel' => $kdmapel));
		}
